...
const portfolios = [
  {
    ...
    description: 'A headless, multi-storefront e-commerce application processing millions of pageviews and high concurrent sales.',
  ...
  },
  {
    ...
    description: 'Real-time driver tracking, automated route calculations, and delivery receipts with signature upload.',
  ...
  },
  {
    ...
    description: 'An enterprise ERP uniting material tracking, warehouse barcodes, and customer billing into one pane of glass.',
  ...
  },
  {
    ...
    description: 'A cloud-based restaurant POS running on mobile tablet terminals, featuring offline kitchen order queueing.',
  ...
  },
  {
    ...
    category: 'UI/UX Design',
    client: 'Aura Capital',
    description: 'Comprehensive rebranding and modern SaaS design layout for a decentralized investment platform.',
  ...
  },
  {
    ...
    description: 'A full content hub rebuild and schema optimization campaign leading to first-page ranking for competitive SaaS keywords.',
...
const technologies = [
  { name: 'React', category: 'Frontend', desc: 'Component-driven frontend UI development.' },
  { name: 'Next.js', category: 'Frontend', desc: 'Full-stack React framework with SSR and SSG.' },
  { name: 'Vite', category: 'Frontend', desc: 'Ultra-fast build tooling and hot module replacement.' },
  { name: 'JavaScript', category: 'Frontend', desc: 'Dynamic programming scripting language.' },
  { name: 'TypeScript', category: 'Frontend', desc: 'Type-safe JavaScript for scalable codebases.' },
  { name: 'Tailwind CSS', category: 'Frontend', desc: 'Utility-first styling for modern design tokens.' },
  { name: 'Framer Motion', category: 'Frontend', desc: 'Premium page transitions and scroll animations.' },
  { name: 'React Native', category: 'Mobile', desc: 'Cross-platform mobile apps with native performance.' },
  { name: 'Flutter', category: 'Mobile', desc: 'Google UI toolkit for multi-platform apps.' },
  { name: 'Node.js', category: 'Backend', desc: 'Server-side runtime environment.' },
  { name: 'Express.js', category: 'Backend', desc: 'Fast minimalist web framework for APIs.' },
  { name: 'Python', category: 'Backend', desc: 'Versatile language for backend, AI/ML, and automation.' },
  { name: 'Go', category: 'Backend', desc: 'High-performance language for concurrent systems.' },
  { name: 'GraphQL', category: 'Backend', desc: 'Flexible query language for efficient API data fetching.' },
  { name: 'MongoDB', category: 'Database', desc: 'NoSQL document database for scalable JSON storage.' },
  { name: 'PostgreSQL', category: 'Database', desc: 'Powerful relational database for complex queries.' },
  { name: 'SQLite', category: 'Database', desc: 'Lightweight embedded database for offline-first apps.' },
  { name: 'Redis', category: 'Database', desc: 'In-memory cache for ultra-fast data retrieval.' },
  { name: 'TensorFlow', category: 'AI/ML', desc: 'End-to-end ML framework for deep learning models.' },
  { name: 'PyTorch', category: 'AI/ML', desc: 'Flexible ML framework for research and production.' },
  { name: 'OpenAI API', category: 'AI/ML', desc: 'GPT integration for NLP and generative AI features.' },
  { name: 'Docker', category: 'Infrastructure', desc: 'Containerization for consistent environment hosting.' },
  { name: 'AWS', category: 'Infrastructure', desc: 'Cloud computing platform for scalable infrastructure.' },
  { name: 'GCP', category: 'Infrastructure', desc: 'Google Cloud for AI/ML and data analytics workloads.' },
  { name: 'Cloudflare', category: 'Infrastructure', desc: 'Edge CDN routing, caching, and DNS management.' },
  { name: 'GitHub', category: 'Tools', desc: 'Version control, issue tracking, and CI/CD automation.' },
  { name: 'Figma', category: 'Tools', desc: 'Collaborative design tool for UI/UX prototyping.' },
];
